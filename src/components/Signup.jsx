...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 transition-colors duration-200 py-12">
      ...
      <div className="w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-white mb-2 tracking-tight">Create an account</h1>
          <p className="text-zinc-500 dark:text-zinc-400 text-sm">Start your Curator journey</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                disabled={loading}
              />
              <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-400 dark:text-zinc-500 text-lg">check_circle</span>
            </div>
          </div>
        ...
        <p className="mt-8 text-center text-zinc-500 dark:text-zinc-400 text-sm">
          ...
          <a href="/login" className="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-700 dark:hover:text-blue-300 transition-colors">Sign in</a>
        </p>
      </div>
    </div>
  );
